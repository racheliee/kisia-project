      ...
      7771: function (t, n, e) {
        ...
        t.exports = function (t, n, e, c, d, h, E) {
          ...
          if (
            ...
            if (((R = { values: T(k), keys: h ? N : T(S), entries: T(O) }), E))
              for (A in R) (b || I || !(A in L)) && p(L, A, R[A]);
            else r({ target: n, proto: !0, forced: b || I }, R);
          return (
            (i && !E) || L[w] === N || p(L, w, N, { name: d }), (y[n] = N), R
          );
        };
      },
      5746: function (t, n, e) {
            ...
            : S && S.now
              ...
              : O && !g
                ...
                : a.addEventListener &&
                    ...
                    "file:" !== r.protocol &&
                    !v(I)
                  ? ((o = I), a.addEventListener("message", _, !1))
                  : (o =
                      R in y("script")
                        ? function (t) {
        ...
        var r,
          ...
          at = function (t, n, e) {
            ...
            Q
              ...
              !Z && (o = s["on" + t])
                ? o(r)
                : t === tt && A("Unhandled promise rejection", e);
          },
          ut = function (t) {
            l(E, s, function () {
              var n,
        ...
        d =
          (e(5843),
          {
            ...
            version: {
              loader: e(4147).i8,
              sdk: {
                stable: null !== (i = "2.30.1") ? i : "",
                latest: null !== (c = "2.30.2") ? c : "",
              },
            },
            policy: {
              version: "240829.00",
            ...
            o(e, [
              ...
              },
              {
                ...
                value: function (t, n, e, r) {
                  return S.isBlank(t)
                    ? w().reject(new Error("Received invalid key, ".concat(t)))
                    : S.isBlank(e)
                      ? w().reject(
                          new Error("Received invalid src, ".concat(e)),
                        )
                      : (this.resources[t] ||
        ...
        P = (function () {
          function n() {
            ...
            t(this, n),
              ...
              (this.phase = d.phase),
              (this.policyResponse = d.policy),
              (this.sdkStableVersion = j),
              (this.sdkLatestVersion = O),
              (this.allowedSdkVersionList = [j, O]);
          }
          return (
            o(n, [
              {
                ...
                value: function () {
                  var t,
                    ...
                    v =
                      null == f || null === (t = f.sdk) || void 0 === t
                        ? void 0
                        : t.stableVersion,
                    y =
                      null == f || null === (n = f.sdk) || void 0 === n
                        ? void 0
                        : n.latestVersion,
                    h =
                      null == f || null === (e = f.sdk) || void 0 === e
                        ? void 0
                        : e.latestRatio;
                  if (
                    (v &&
                      ((this.sdkStableVersion = v),
                      this.allowedSdkVersionList.push(v)),
                    y &&
                      ((this.sdkLatestVersion = y),
                      this.allowedSdkVersionList.push(y)),
                    ...
                    var g,
                      ...
                      k =
                        null == S ||
                        null === (g = S.versionInfo) ||
                        void 0 === g
                          ? void 0
                          : g.sdkVersion;
                    if (
                      ((o =
                        k && l()((m = this.allowedSdkVersionList)).call(m, k)
                          ? k
                          : this.sdkStableVersion),
                      (i =
                        null !== (b = null == S ? void 0 : S.sdkInfo) &&
                        void 0 !== b
                          ? b
                          : { latestRatio: 0 }),
                      (c =
                        null !== (w = null == S ? void 0 : S.sentryInfo) &&
                        void 0 !== w
                          ? w
                          : { enableSentry: !1 }),
                      S && k !== o)
                      ...
                      T =
                        null !==
                          (j =
                            null != h
                              ? h
                              : null === (P = this.policyResponse.sdk) ||
                                  void 0 === P
                                ? void 0
                                : P.latestRatio) && void 0 !== j
                          ? j
                          : 0;
                    (o = this.pickSdkVersion(T)),
                      (i =
                        null !== (R = null == f ? void 0 : f.sdk) &&
                        void 0 !== R
                          ? R
                          : this.policyResponse.sdk),
                      (c =
                        null !== (A = null == f ? void 0 : f.sentry) &&
                        void 0 !== A
                          ? A
                  ...
                  E.saveAndLoad(
                    "GFP_WEB_SDK",
                    "javascript",
                    p()((r = "".concat(d.gfp.chunkUrl, "/"))).call(
                      r,
                      o,
                      "/gfp-sdk.js",
                    ),
